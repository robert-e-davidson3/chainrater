...
export class Dashboard extends LitElement {
  ...
  viewItem(uri, uriHash) {
    ...
    this.dispatchEvent(new CustomEvent('view-uri', {
      detail: { uri, uriHash },
      bubbles: true,
      composed: true
    }));
  ...
  async loadDashboardData() {
    ...
    setTimeout(() => {
      ...
      this.topRatedURIs = [
        ...
        {
          uriHash: '0x6789012345abcdef6789012345abcdef6789012345abcdef6789012345abcdef',
          decodedURI: 'movie://The Matrix',
          averageScore: 4.4,
          ratingCount: 10
        },
        {
          uriHash: '0x7890123456abcdef7890123456abcdef7890123456abcdef7890123456abcdef',
      ...
      this.topVarianceURIs = [
        {
          uriHash: '0x8901234567abcdef8901234567abcdef8901234567abcdef8901234567abcdef',
          decodedURI: 'movie://Star Wars: The Last Jedi',
          variance: 1.8,
          ratingCount: 20
        },
        {
          uriHash: '0x9012345678abcdef9012345678abcdef9012345678abcdef9012345678abcdef',
        ...
        {
          uriHash: '0xa123456789abcdefa123456789abcdefa123456789abcdefa123456789abcdef',
          decodedURI: 'book://The Bible',
          variance: 1.2,
          ratingCount: 30
        },
        {
          uriHash: '0xb234567890abcdefb234567890abcdefb234567890abcdefb234567890abcdef',
